...
export default function Section9() {
    ...
    return (
        <Fragment>
            ...
            >
                <Stack mx={['auto', 'auto', 'auto', '0px', '0px']} pl={['0px', '0px', '0px', '120px', '120px']} pt="116px">
                    <Text as="h4" fontSize="50px" fontFamily={fontsFamilies[0]} >Ade <strong>Bakes</strong></Text>
                    <Text>Street 20, Nigeria.</Text>
                    <Text mt="34px !important" >Office Telephone : +234 0123456789</Text>
                    <Text>Mobile : +234 012345678</Text>
                    <Text mt="34px !important">Email : admin@website.com</Text>
                    <Text >Inquiries : email@website.com</Text>
                    <Text mt="34px !important">Mon-Fri: 9am to 6pm</Text>
                    <Flex gridGap="20px" mt="34px !important" justifyContent={['center', 'center', 'center', 'left', 'left']}>
                        {
